...
class _PrescriptionsScreenState extends State<PrescriptionsScreen> {
  ...
  Future<void> loadData() async {
    try {
      ...
      final data = await PrescriptionService.getPrescriptionsByPatient(patientId);
  ...
  void _onViewDetail(BuildContext context, String date, int recordId) async {
    try {
      final details = await PrescriptionService.getPrescriptionDetails(recordId);
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (_) => PrescriptionDetailScreen(date: date, details: details),
        ),
      );
    } catch (e, stack) {
      print(stack);
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: OutlinedButton.icon(
                            onPressed: () => _onViewDetail(context, item.date, item.recordId),
